...
export default function Estadisticas() {
  /* Dual-role: la agencia tiene un dashboard propio. El promotor
   * ve este dashboard completo con KPIs + gráficos + rankings. */
        ...
        <div className="max-w-content mx-auto flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          <div>
            ...
            <h1 className="text-[19px] sm:text-[22px] font-bold tracking-tight mt-1 leading-tight">
              Estadísticas <span className="text-muted-foreground font-medium">· resumen de tu semana</span>
            </h1>
          </div>

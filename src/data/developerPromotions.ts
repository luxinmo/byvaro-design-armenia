...
const RAW_DEV_PROMOTIONS: DevPromotion[] = [
   ...
   * Status "active" · publicada y visible en /promotor/ID8TAG9C. */
  {
    ...
    buildingType: "unifamiliar-multiple",
    canShareWithAgencies: true,
    /* `activity` quitado del seed AEDAS · antes copiaba los números
     *  de Luxinmo dev-2 (22 consultas · 3 reservas · 8 visitas · +55%).
     *  Cuando aterrice backend `activity` se computa real desde
     *  registros/visitas/oportunidades del workspace dueño. */
    collaboration: {
      comisionInternacional: 4.5,
      comisionNacional: 4.5,
      diferenciarNacionalInternacional: false,
  ...
  /* AEDAS Homes (`prom-1`) · 2 promociones reales del workspace.
   *  Migradas desde `EXTERNAL_PROMOTOR_PORTFOLIO` para que sean
   *  clickables y aparezcan en `/promociones` cuando Carlos entra. */
  {
    id: "dev-aedas-1",
    ownerOrganizationId: "prom-1",
    code: "PRM-AED-0001",
    name: "Célere Castellana",
  ...
  /* Neinor Homes (`prom-2`) · segunda promo · `dev-neinor-1` ya cubre
   *  Edificio Bilbao Alta · esta es Vegas del Saz. */
  {
    id: "dev-neinor-2",
    ownerOrganizationId: "prom-2",
    code: "PRM-NHO-0002",
  ...
  /* Metrovacesa (`prom-4`) · segunda promo · `dev-metrovacesa-1` ya
   *  cubre Mirador del Levante · esta es Skyline Plaza. */
  {
    id: "dev-metrovacesa-2",
    ownerOrganizationId: "prom-4",
    code: "PRM-MVC-0002",
    name: "Skyline Plaza",

...
const EVENT_META: Record<ContactTimelineEventType, {
  ...
  contact_created:   { icon: Plus,           iconClass: "bg-success/15 text-success dark:text-success" },
  ...
  tag_added:         { icon: Tag,            iconClass: "bg-warning/15 text-warning dark:text-warning" },
  tag_removed:       { icon: Tag,            iconClass: "bg-muted text-muted-foreground" },
  status_changed:    { icon: BadgeCheck,     iconClass: "bg-warning/15 text-warning dark:text-warning" },
  visit_scheduled:   { icon: CalendarIcon,   iconClass: "bg-warning/15 text-warning dark:text-warning" },
  visit_done:        { icon: CheckCircle2,   iconClass: "bg-success/15 text-success dark:text-success" },
  visit_cancelled:   { icon: XCircle,        iconClass: "bg-destructive/15 text-destructive" },
  visit_evaluated:   { icon: CheckCircle2,   iconClass: "bg-success/15 text-success dark:text-success" },
  ...
  email_delivered:   { icon: MailCheck,      iconClass: "bg-success/15 text-success dark:text-success" },
  email_opened:      { icon: MailOpen,       iconClass: "bg-violet-500/15 text-violet-700 dark:text-violet-400" },
  whatsapp_sent:     { icon: WhatsAppIcon as typeof Sparkles, iconClass: "bg-success/15 text-success dark:text-success" },
  whatsapp_received: { icon: WhatsAppIcon as typeof Sparkles, iconClass: "bg-success/15 text-success dark:text-success" },
  ...
  document_uploaded: { icon: FileText,       iconClass: "bg-warning/15 text-warning dark:text-warning" },

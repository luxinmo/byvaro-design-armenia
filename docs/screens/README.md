...
| Oportunidades | `/oportunidades` | [`oportunidades.md`](oportunidades.md) | ✅ diseñada |
| Oportunidad · detalle | `/oportunidades/:id` | [`oportunidad-detalle.md`](oportunidad-detalle.md) | ✅ diseñada |
